...
- (void)enable
{
    ...
    CGFloat x = UIScreen.mainScreen.bounds.size.width - kMeterWidth;
    CGFloat y = UIApplication.sharedApplication.statusBarFrame.origin.y;
    if (@available(iOS 11.0, *)) {
        UIEdgeInsets insets = [UIApplication sharedApplication].windows.firstObject.safeAreaInsets;
        y = insets.top;
    }
    self.meterLabel = [[UILabel alloc] initWithFrame:CGRectMake(x, y,
